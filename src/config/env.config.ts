    ...
    return {
      ...
      DATABASE: {
        CONNECTION: {
          ...
          CLIENT_NAME: process.env.DATABASE_CONNECTION_CLIENT_NAME || 'evolution_exchange',
        },
        PROVIDER: process.env.DATABASE_PROVIDER || 'postgresql',
        SAVE_DATA: {
          INSTANCE: process.env?.DATABASE_SAVE_DATA_INSTANCE !== 'false',
          NEW_MESSAGE: process.env?.DATABASE_SAVE_DATA_NEW_MESSAGE !== 'false',
          MESSAGE_UPDATE: process.env?.DATABASE_SAVE_MESSAGE_UPDATE !== 'false',
          CONTACTS: process.env?.DATABASE_SAVE_DATA_CONTACTS !== 'false',
          CHATS: process.env?.DATABASE_SAVE_DATA_CHATS !== 'false',
          HISTORIC: process.env?.DATABASE_SAVE_DATA_HISTORIC !== 'false',
          LABELS: process.env?.DATABASE_SAVE_DATA_LABELS !== 'false',
          IS_ON_WHATSAPP: process.env?.DATABASE_SAVE_IS_ON_WHATSAPP !== 'false',
          IS_ON_WHATSAPP_DAYS: Number.parseInt(process.env?.DATABASE_SAVE_IS_ON_WHATSAPP_DAYS ?? '7'),
        },
        DELETE_DATA: {
          LOGICAL_MESSAGE_DELETE: process.env?.DATABASE_DELETE_MESSAGE !== 'false',
        },
      },
      RABBITMQ: {
        ...
        EXCHANGE_NAME: process.env?.RABBITMQ_EXCHANGE_NAME || 'evolution',
      ...
      NATS: {
        ...
        EXCHANGE_NAME: process.env?.NATS_EXCHANGE_NAME || 'evolution',
      ...
      PUSHER: {
        ...
        GLOBAL: {
          ...
          USE_TLS: process.env?.PUSHER_GLOBAL_USE_TLS !== 'false',
        },
        EVENTS: {
          APPLICATION_STARTUP: process.env?.PUSHER_EVENTS_APPLICATION_STARTUP !== 'false',
          ...
          QRCODE_UPDATED: process.env?.PUSHER_EVENTS_QRCODE_UPDATED !== 'false',
          MESSAGES_SET: process.env?.PUSHER_EVENTS_MESSAGES_SET !== 'false',
          MESSAGES_UPSERT: process.env?.PUSHER_EVENTS_MESSAGES_UPSERT !== 'false',
          MESSAGES_EDITED: process.env?.PUSHER_EVENTS_MESSAGES_EDITED !== 'false',
          MESSAGES_UPDATE: process.env?.PUSHER_EVENTS_MESSAGES_UPDATE !== 'false',
          MESSAGES_DELETE: process.env?.PUSHER_EVENTS_MESSAGES_DELETE !== 'false',
          SEND_MESSAGE: process.env?.PUSHER_EVENTS_SEND_MESSAGE !== 'false',
          SEND_MESSAGE_UPDATE: process.env?.PUSHER_EVENTS_SEND_MESSAGE_UPDATE !== 'false',
          CONTACTS_SET: process.env?.PUSHER_EVENTS_CONTACTS_SET !== 'false',
          CONTACTS_UPDATE: process.env?.PUSHER_EVENTS_CONTACTS_UPDATE !== 'false',
          CONTACTS_UPSERT: process.env?.PUSHER_EVENTS_CONTACTS_UPSERT !== 'false',
          PRESENCE_UPDATE: process.env?.PUSHER_EVENTS_PRESENCE_UPDATE !== 'false',
          CHATS_SET: process.env?.PUSHER_EVENTS_CHATS_SET !== 'false',
          CHATS_UPDATE: process.env?.PUSHER_EVENTS_CHATS_UPDATE !== 'false',
          CHATS_UPSERT: process.env?.PUSHER_EVENTS_CHATS_UPSERT !== 'false',
          CHATS_DELETE: process.env?.PUSHER_EVENTS_CHATS_DELETE !== 'false',
          CONNECTION_UPDATE: process.env?.PUSHER_EVENTS_CONNECTION_UPDATE !== 'false',
          LABELS_EDIT: process.env?.PUSHER_EVENTS_LABELS_EDIT !== 'false',
          LABELS_ASSOCIATION: process.env?.PUSHER_EVENTS_LABELS_ASSOCIATION !== 'false',
          GROUPS_UPSERT: process.env?.PUSHER_EVENTS_GROUPS_UPSERT !== 'false',
          GROUP_UPDATE: process.env?.PUSHER_EVENTS_GROUPS_UPDATE !== 'false',
          GROUP_PARTICIPANTS_UPDATE: process.env?.PUSHER_EVENTS_GROUP_PARTICIPANTS_UPDATE !== 'false',
          CALL: process.env?.PUSHER_EVENTS_CALL !== 'false',
      ...
      WA_BUSINESS: {
        ...
        VERSION: process.env.WA_BUSINESS_VERSION || 'v20.0',
        LANGUAGE: process.env.WA_BUSINESS_LANGUAGE || 'en_US',
      },
      LOG: {
        LEVEL:
      ...
      WEBHOOK: {
        ...
        EVENTS: {
          ...
          QRCODE_UPDATED: process.env?.WEBHOOK_EVENTS_QRCODE_UPDATED !== 'false',
          MESSAGES_SET: process.env?.WEBHOOK_EVENTS_MESSAGES_SET !== 'false',
          MESSAGES_UPSERT: process.env?.WEBHOOK_EVENTS_MESSAGES_UPSERT !== 'false',
          MESSAGES_EDITED: process.env?.WEBHOOK_EVENTS_MESSAGES_EDITED !== 'false',
          MESSAGES_UPDATE: process.env?.WEBHOOK_EVENTS_MESSAGES_UPDATE !== 'false',
          MESSAGES_DELETE: process.env?.WEBHOOK_EVENTS_MESSAGES_DELETE !== 'false',
          SEND_MESSAGE: process.env?.WEBHOOK_EVENTS_SEND_MESSAGE !== 'false',
          SEND_MESSAGE_UPDATE: process.env?.WEBHOOK_EVENTS_SEND_MESSAGE_UPDATE !== 'false',
          CONTACTS_SET: process.env?.WEBHOOK_EVENTS_CONTACTS_SET !== 'false',
          CONTACTS_UPDATE: process.env?.WEBHOOK_EVENTS_CONTACTS_UPDATE !== 'false',
          CONTACTS_UPSERT: process.env?.WEBHOOK_EVENTS_CONTACTS_UPSERT !== 'false',
          PRESENCE_UPDATE: process.env?.WEBHOOK_EVENTS_PRESENCE_UPDATE !== 'false',
          CHATS_SET: process.env?.WEBHOOK_EVENTS_CHATS_SET !== 'false',
          CHATS_UPDATE: process.env?.WEBHOOK_EVENTS_CHATS_UPDATE !== 'false',
          CHATS_UPSERT: process.env?.WEBHOOK_EVENTS_CHATS_UPSERT !== 'false',
          CHATS_DELETE: process.env?.WEBHOOK_EVENTS_CHATS_DELETE !== 'false',
          CONNECTION_UPDATE: process.env?.WEBHOOK_EVENTS_CONNECTION_UPDATE !== 'false',
          LABELS_EDIT: process.env?.WEBHOOK_EVENTS_LABELS_EDIT !== 'false',
          LABELS_ASSOCIATION: process.env?.WEBHOOK_EVENTS_LABELS_ASSOCIATION !== 'false',
          GROUPS_UPSERT: process.env?.WEBHOOK_EVENTS_GROUPS_UPSERT !== 'false',
          GROUP_UPDATE: process.env?.WEBHOOK_EVENTS_GROUPS_UPDATE !== 'false',
          GROUP_PARTICIPANTS_UPDATE: process.env?.WEBHOOK_EVENTS_GROUP_PARTICIPANTS_UPDATE !== 'false',
          CALL: process.env?.WEBHOOK_EVENTS_CALL !== 'false',
        ...
        REQUEST: {
          TIMEOUT_MS: Number.parseInt(process.env?.WEBHOOK_REQUEST_TIMEOUT_MS) || 60000,
        },
        RETRY: {
      ...
      QRCODE: {
        ...
        COLOR: process.env.QRCODE_COLOR || '#175197',
      },
      TYPEBOT: {
        ENABLED: process.env?.TYPEBOT_ENABLED === 'true',
        API_VERSION: process.env?.TYPEBOT_API_VERSION || 'latest',
      ...
      CHATWOOT: {
        ...
        IMPORT: {
          ...
          PLACEHOLDER_MEDIA_MESSAGE: process.env?.CHATWOOT_IMPORT_PLACEHOLDER_MEDIA_MESSAGE !== 'false',
        },
      },
      OPENAI: {
      ...
      S3: {
        ...
        PORT: Number.parseInt(process.env?.S3_PORT || '443'),
      ...
      AUTHENTICATION: {
        ...
        EXPOSE_IN_FETCH_INSTANCES: process.env?.AUTHENTICATION_EXPOSE_IN_FETCH_INSTANCES !== 'false',
      },
      METRICS: {
        ENABLED: process.env?.PROMETHEUS_METRICS === 'true',
        AUTH_REQUIRED: process.env?.METRICS_AUTH_REQUIRED !== 'false',
